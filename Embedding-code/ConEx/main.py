...
class Experiment:
    ...
    def train_and_eval(self, d_info):
        ...
        torch.save(model.state_dict(), self.storage_path + 'Conex.pt')
...
if __name__ == '__main__':
    ...
    parser.add_argument("--dataset", type=str, default="KGs/Lidl", nargs="?",
    ...
    parser.add_argument("--dr", type=float, default=1.0, nargs="?",
                        help="Decay rate.")
    parser.add_argument("--conv_out", type=int, default=64, nargs="?",
                        help="Number of channels for 2D-Convolution.")
    parser.add_argument("--projection_size", type=int, default=1088, nargs="?",
